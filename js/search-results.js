const sampleBooks =
    [
        ...
        },
        {
            ...
            description: "Një thriller psikologjik rreth imoralitetit, obsesionit dhe abuzimit seksual."
        },
        {
            id: 19,
            ...
            description: "Një roman distopik që sfidon normat sociale dhe teknologjike."
        },
        {
            id: 20,
            title: "The Alchimist",
            ...
            description: "Një tregim frymëzues për një bari që ndjek ëndrrën e tij për të gjetur një thesar."
        },
        {
...

        {
            ...
            description: "Fillimi magjik i një sage ku një djalë zbulon se është magjistar dhe nis aventurën e tij."
        },
        {
            id: 6,
            title: "The Hobbit",
            ...
            description: "Një udhëtim epik i Bilbo Baggins për të rifituar thesarin nga dragoi Smaug."
        },
        {
            id: 21,
            ...
            description: "Një djalë i varfër fiton një biletë të artë dhe viziton fabrikën magjike të çokollatës."
        },
        {
            id: 22,
            title: "Matilda",
            ...
            description: "Një vajzë e zgjuar me aftësi të jashtëzakonshme përballet me një drejtoreshë të ligë."
        },
        {
            id: 23,
            title: "Artemis Fowl",
            ...
            description: "Një gjeni kriminel 12-vjeçar përballet me një botë sekrete të elfeve."
        },
        {
            id: 24,
            ...
            description: "Katër fëmijë zbulojnë një botë magjike përmes një gardërobe."
        },
        {
            id: 41,
...

        {
            ...
            description: "Një udhërrëfyes për universin që shpjegon konceptet komplekse të kozmologjisë."
        },
        {
            id: 8,
            ...
            description: "Një teori që shpjegon evoluimin përmes perspektivës së gjeneve."
        },
        {
            id: 25,
            title: "Sapiens",
            ...
            description: "Një histori e njerëzimit, nga Homo sapiens deri në inteligjencën artificiale."
        },
        {
            id: 26,
            ...
            description: "Një eksplorim i teorisë kuantike dhe mistereve të saj."
        },
        {
            id: 27,
            title: "Cosmos",
            ...
            description: "Një udhëtim përmes universit me sqarime të thjeshta mbi galaktikat."
        },
        {
            id: 28,
            ...
            description: "Një vështrim mbi kohën dhe universin, bazuar në punën me Stephen Hawking."
        },
        {
            id: 43,
        ...
        },
        {
            ...
            description: "Një thriller plot mistere për një sekret të fshehur nga Kisha Katolike."
        },
        {
            id: 10,
            ...
            description: "Një tregim distopik për një shoqëri ku gratë trajtohen si pronë."
        },
        {
            id: 29,
            ...
            description: "Një histori prekëse për miqësinë, fajin dhe faljen në Afganistan."
        },
        {
            id: 45,
