const books = {
    ...
    46: { id: 46, title: "Twisted Hate", author: "Ana Huang", image: "images/books/best8.jpg", price: "1,400 ALL", rating: 4.9, category: "bestseller", description: "Discover the addictive world of the Twisted series from TikTok sensation, Ana Huang!Read Twisted Hate now for a steamy enemies to lovers romance. "},
    47: { id: 47, title: "PRIDE AND PREJUDICE TOTE BAG", author: "Papercut", image: "images/books/gift7.jpg", price: "1,300 ALL", rating: 4.8, description: "Një çantë tote elegante me dizajn klasik të romanit 'Pride and Prejudice'. Ideale për lexuesit që duan të marrin librat me vete me stil."},
    48: { id: 48, title: "AGATHA CHRISTIE TRIVIA: 300 KILLER QUESTIONS ON THE QUEEN OF CRIME", author: "Orange Hippo!", image: "images/books/gift8.jpg", price: "1,500 ALL", rating: 4.9,   description: "Një lojë zbavitëse me 300 pyetje për fansat e Agatha Christie. Sfido miqtë me njohuritë rreth Mbretëreshës së Krimeve!"}
